		...
		<div class="footer-top-first">
			<div class="container py-md-5 py-sm-4 py-3">
				...
				<p class="footer-main mb-4">
					If you're considering a new smartphone, looking for a powerful new smartphone or shopping for a new tablet, we make it easy to
					find exactly what you need at a price you can afford. We offer Every Day Low Prices on tablets, accesories, cell phones, baterries
					and iPads, audio, and more.</p>
				<!-- //footer first section -->
				...
				<div class="row footer-info w3-agileits-info">
					...
					<div class="col-md-3 col-sm-6 footer-grids">
						...
						<ul>
							...
							<li class="mb-3">
								<a href="product.php">Accesories</a>
							</li>
							<li class="mb-3">
							...
							<li class="mb-3">
								<a href="product.php">Audio</a>
							</li>
							<li>
								<a href="product2.php">Tablets</a>
							</li>
						</ul>
					</div>
					<!-- //footer categories -->
